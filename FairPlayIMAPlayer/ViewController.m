...
NSString * kFairPlayHLSVideoURL = @"https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8";
...
- (void)setup
{
    ...
    id<BCOVPlaybackSessionProvider> imaSessionProvider = [sdkManager createIMASessionProviderWithSettings:imaSettings adsRenderingSettings:renderSettings adsRequestPolicy:adsRequestPolicy adContainer:self.videoContainer companionSlots:nil upstreamSessionProvider:nil];
                                                          


    // Create an authorization proxy for FairPlay
    // using the FairPlay Application ID and the FairPlay Publisher ID
    //BCOVFPSBrightcoveAuthProxy *proxy = [[BCOVFPSBrightcoveAuthProxy alloc] initWithPublisherId:kFairPlayPublisherId applicationId:kFairPlayApplicationId];
